...
%TODO: Se FysikKod nedan
På civilingenjörsprogrammet Datateknik på Chalmers ingår den obligatoriska fysikkursen
\textit{Fysik för ingenjörer}.
%TODO: För diffust: vad menar ni med "inte jättebra"? Det tar 3-4 klick att hitta statistiken som en del av ett stort kalkylark och där tappar ni nog de flesta innan de egentligen vet vad ni menar. Skriv om ordningen så att "tredjedel" kommer närmare länken + kanske en footnote som ger konkreta siffror för de senaste tre åren eller så.
...
%TODO: Kursen "introduceras" (minst) två gånger med olika mycket detaljer (se även ovan). Red ut detta.
Examinatorn för kursen ``Fysik för ingenjörer, TIF085 (2016)'' Åke Fäldt,
%TODO: Jag är inte övertygad om att detta hör till "bakgrund" egentligen. Se också till att det är tydligt vad som är hans, resp. er, åsikt.
tycker
...
\iffalse
%TODO: Varför ligger den här texten här om den ändå är osynlig?
...
%TODO: skriv om för att undvika upprepningen
...
%TODO: jag känner inte riktigt igen "datorassisterad bevisföring" från kursen?
datorassisterad bevisföring.


%TODO: Denna paragraf verkar inte riktigt passa in här, mitt i DSLsofMath-beskrivning?
För vidare läsning
...
%TODO: "alltså" verkar inte stämma med texten i närheten?
...
perturbationsteori (teori för approximationer av matematiska lösningar). I kursen används boken ``Structure and %nämna referens till boken? TODO: ja
...
%TODO: "\cite" ska vara _i_ meningen, inte efter punkten. Och inte precis efter "Scheme" (där skulle ev. en länk till språket Scheme passa, men behövs inte här), utan precis där författarna anges. Och författarna är det bättre att låta datorn fylla i själv med \citeauthor eller \citelong eller liknande.
