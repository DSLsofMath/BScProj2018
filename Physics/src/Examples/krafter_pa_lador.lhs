...
![Incline](lutande_plan.png){.float-img-left}
...
Good:   45* lutning - 5N både i x och y led. 
    Pyth: 5^2 + 5^2 =/= 10^2
    
    det borde bli:  100 = a^2 + a^2
                     50 = a^2
              5*sqrt(2) = a        och det är det ju. xD

*Main> fr (V2 0 10) (pi/6)
(-4.330127018922193 x, 2.499999999999999 y)
```

With frictioncoefficient:
-------------------------
...
Summing the previous resultant with the force of the friction.
