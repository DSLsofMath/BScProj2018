...
Att vi skulle dela upp områdena i grundläggande och komposita områden var vi projektstarten inget vi planerat för (se även avsnitt \ref{sec:valet}). Inte heller hade vi trott att det fanns mindre ``lämpade'' områden. Det var med andra ord oväntat för oss att denna uppdelning skulle behöva göras och att vissa områden inte gick att göra domänspecifka språk för.

Vad är då skillnaden mellan dessa två kategorier av områden?
Den viktigaste skillnaden är att till exempel matematisk analys har tydlig data och operationer 
