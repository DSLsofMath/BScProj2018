...
Ett exempel på ett område som inte har några tydliga data och operationer är lutande plan. Ett sådant område har istället teoretiska samband som relaterar olika egenskper i systemet till varandra. Ett sådant samband är till exempel $a = g \cdot \sin(v)$ för det lutande planet i figur \ref{fig:lutande_plan}.
...
verktyg som behövs för att koda upp lösningar av problem. Därav innehåller det resulterande läromaterialet, som beskrivs i avsnitt \ref{sec:laromaterial}, inga domänspecifika språk för fysik.

Vad är då skillnaden mellan dessa två kategorier av områden?
Den viktigaste skillnaden är att till exempel analys har tydlig data och operationer 
...
Även språkvalet för hemsidan gjordes för att öka tillgängligheten, i ett tidigt
skede valde vi att skriva läromaterialet på engleska. Fler kan engelska än
svenska, så på detta sätt kan läromaterialet komma fler till gagn.
