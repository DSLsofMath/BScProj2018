...
Mathematics'' (``DSLofMath'') eller ``Matematikens domänspecifika språk'' givits som en
...
Även på MIT har en kurs inte helt olik DSLofMath tidigare givits som berör både fysik
...
% TODO: Omformulera "kandidatarbete om DSL"
Utöver DSLofMath-kursen har det även tidigare gjorts ett kandidatarbete om DSL 
...
Vår tanke med detta kandidatarbete är att, likt premissen bakom DSLofMath
