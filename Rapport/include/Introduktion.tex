...
är Patrik Jansson huvudföreläsare.
...
Det direkta målet med kursen DSLsofMath är att förbättra den
...
tal och matriser ur ett funktionellt programmeringsperspektiv i det funktionella programmeringsspråket  %Förklara funktionellt programmeringspersp.
...
områden inom fysik. Den tillhörande brödtexten är menad att beskriva både de domänspecifika språken, fysiken i sig,    %DSL:erna är bruten svenska?
