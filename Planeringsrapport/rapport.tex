...
% Varför
På civilingenjörsprogrammet Datateknik på Chalmers ingår fysikkursen \textit{Fysik för ingenjörer}. Många Datateknik-studenter (''datateknologer'') tycker att fysikkursen är ointressant, svår och irrelevant för programmet.  Vår tanke med detta projekt är att göra kursen både intressant och relevant, och därmed förhoppningvis enklare också.

% Vad
Vår idé är att presentera fysik på ett sätt som skiljer sig från hur det vanligtvis presenteras. Vi tänker använda domänspecifika språk i Haskell för att modellera fysik och på så sätt göra kopplingen till programmet tydligare.

% Relaterat till
Detta sätt att behandla områden är inget nytt. Faktum är att detta kandidatarbete i sig är en avgrening från det likartade projektet \textit{Matematikens domänspecika språk} som presenterar matematik så som derivator, komplexa tal och matriser ur ett funktionellt programmeringsperspektiv. Detta projeket kan också kopplas till den större diskussionen om varför matematik och fysik lärs på Datateknik och likartade program, en fråga många datateknologer ställt sig.
% TODO: Ni som kan något om den hära "strcuture and implementtion..." får gärna skriva något om den här.

% Relevant för
Projektet är relevant för datateknologer som läser en fysikkurs. Men det kan också bli relevant för en fysikstudent som är ute efter en inkörsport till funktionell programmering. Förhoppningsvis blir det också relevant för de som är intresserade av domänspecifika språk i stort, pedagoger och föreläsare inom de berörda områdena och kanske till och med programledningen som ser vår rapport som ett skäl att introducera innehåll av denna karaktär i till exempel fysikkursen.
