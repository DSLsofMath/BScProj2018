...
Kombinationen av DSL+fysik diskussionen: kunde provat flera olika övergrupande tankesätt, olika varianter. Återigen testgrupp borde varit större. Gjort större eftersökningar på liknande områden.
...
Oskar: Jag tycker inte detta avsnitt behövs längre
