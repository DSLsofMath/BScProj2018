...
\section{Fysik för ingenjörer}

\begin{draft}
  \emph{Fysik för ingenjörer} är en obligatorisk kurs för studenterna på det datatekniska programmet. Kursen täcker grunderna inom klassisk mekanik, termodynamik och vågrörelselära. Det ingår även en del tillämpad   matematik såsom vektorer och differentialkalkyl. Kursen föreläsare och examinator är Åke Fäldt.
\end{draft}

\section{Hemsidan}
\todo{Ha beskrivning av individuella teknologier} Literat och lhs m.m. står redan om i annat avsnitt.
\begin{draft}
